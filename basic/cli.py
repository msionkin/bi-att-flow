...
flags.DEFINE_integer("num_epochs", 3, "Total number of epochs for training [12]")
flags.DEFINE_integer("num_steps", 2000, "Number of steps [20000]")
...
flags.DEFINE_integer("print_loss_period", 10, "Print Loss Period [1000]")
...
flags.DEFINE_integer("word_count_th", 20, "word count th [100]")
flags.DEFINE_integer("char_count_th", 50, "char count th [500]")
flags.DEFINE_integer("sent_size_th", 1000, "sent size th [64]")
flags.DEFINE_integer("num_sents_th", 100, "num sents th [8]")
flags.DEFINE_integer("ques_size_th", 1000, "ques size th [32]")
flags.DEFINE_integer("word_size_th", 20, "word size th [16]")
